...
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.4.2/contracts/utils/EnumerableSet.sol";
...
contract ORI is DelegateERC20, Ownable {
    ...
    constructor(uint256 airdropSupply) public ERC20("Oriswap Token", "ORI"){
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(_addMinter != address(0), "Oriswap Token: _addMinter is the zero address");
        return EnumerableSet.add(_minters, _addMinter);
    }

    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "Oriswap Token: _delMinter is the zero address");
    ...
    function getMinter(uint256 _index) public view onlyOwner returns (address){
        require(_index <= getMinterLength() - 1, "Oriswap Token: index out of bounds");
        return EnumerableSet.at(_minters, _index);
    }

    // modifier for mint function
    modifier onlyMinter() {
        require(isMinter(msg.sender), "Oriswap Token: caller is not the minter");
        _;
    }
}